jQuery(document).ready(function($) {
    ...
    $(document).on( "click", "#tapi-table-container .pager li a, #tapi-table-container th a", function(e){ 
    ...
    $(document).on( "click", "#tapi-table-container .tapi-edit", function(e){ 
        e.preventDefault();
    ...
    $(document).on( "click", "#tapi-table-container .tapi-save", function(e){ 
        element = $(this).parent();
    ...
    $(document).on( "click", "#tapi-table-container .tapi-delete", function(e){ 
    ...
    $(document).on( "click", "#tapi-table-container .tapi-insert-btn", function(e){ 
        params = {
            query_uuid : $('input[name=tapi_query_uuid]').val(),
        };
        fields = $('#tapi-table-container .tapi-insert').each(function(index, value){
            current = $(this);
